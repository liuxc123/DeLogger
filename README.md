...
//Use it:
//For AFNetworking
let sessionManager = AFNetworking.SessionManager(configuration: configuration)
...
You can use [CocoaPods](http://cocoapods.org/) to install `DeLogger` by adding it to your `Podfile`:
